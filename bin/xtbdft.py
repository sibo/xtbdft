...
if not (os.path.exists(os.path.exapnduser(goodvibesPy))):
    ...
    exit()
if not (os.path.exists(os.path.exapnduser(xtbPath + "/bin/xtb"))):
    print("Error: xtb does not exist at " + xtbPath + "/bin/xtb \n Please modify line 8 of xtbdft.py to reflect where xtb is located.\nExiting...")
    exit()
if not (os.path.exists(os.path.exapnduser(xtbPath + "/bin/crest"))):
